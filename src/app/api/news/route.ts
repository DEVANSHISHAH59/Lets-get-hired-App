...
export async function GET() {
  const results = await Promise.allSettled([
    fetchRSSFeed('https://techcrunch.com/category/artificial-intelligence/feed/', 'TechCrunch'),
  ...
  return NextResponse.json({ news: deduped, lastUpdated: new Date().toISOString(), count: deduped.length })
}
